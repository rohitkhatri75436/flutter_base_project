...
// ApiResponse:-----------------------------------------------------------
class ApiResponse<T> {
  ApiResponse.success(this.data,this.statusCode) : apiCallState = ApiCallState.success;

  ApiResponse.loading() : apiCallState = ApiCallState.loading;

  ApiResponse.error(this.message,[this.statusCode]) : apiCallState = ApiCallState.error;
